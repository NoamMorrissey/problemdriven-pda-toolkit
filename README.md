...
┌─────────────────────────────────────────────────────────────────────┐
│                                                                     │
│  Human writes PS  ──→  /pda-problem  VALIDATES  ──→ ✅ Human approves│
│                                                                     │
│  Human writes SB  ──→  /pda-solution VALIDATES  ──→ ✅ Human approves│
│                                                                     │
│  Human writes CS  ──→  /pda-context  VALIDATES  ──→ ✅ Human approves│
│                                                                     │
│                        /pda-ai-build GENERATES  ──→ ✅ Human approves│
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```

Phases 1-3: Humans think, AI validates. Phase 4: AI builds, humans supervise. Four human approval gates. The AI does not move forward until you say so.
...
# Write your Problem Statement in docs/pda-problem.md using the template, then:
/pda-problem
```
...
your-project/
├── docs/
│   ├── pda-problem.md              ← Problem Statement (written by human, validated by /pda-problem)
│   ├── pda-solution-brief.md       ← Solution Brief (written by human, validated by /pda-solution)
│   └── pda-context-spec.md         ← Context Specification (written by human, validated by /pda-context)
│
├── templates/
